...
export function AboutTeam({ lang }: { lang: "en" | "km" }) {
  ...
  return (
    <>
      {/* Top section */}
      <div>
        <h1 className="bg-gradient-to-r from-[#54A7F6] to-[#004282] text-transparent bg-clip-text text-center text-4xl font-bold leading-snug mt-12 mb-8">
          {t("about.team.title1")}
        </h1>
